...
def divide_raster(src_path, temp_divided_path, divisor=10000):
    ...
    # os.replace(temp_divided_path, src_path)
...
if __name__ == "__main__":
    divide_raster(r"C:\Users\5298954\Documents\Projects\Exposure_Map\project_geoserver\data_dir\data\BSW_DIS\Albania\BSW_DIS_20130101.tif",
                  r"C:\Users\5298954\Documents\Projects\Exposure_Map\project_geoserver\data_dir\data\BSW_DIS\Albania\BSW_DIS_20130101_divided.tif",
                  divisor=1)