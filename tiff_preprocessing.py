...
def preprocess_tiff(file_path):
    ...
    # reproject_raster(file_path, temp_reprojected_path)
...
def main():
    ...
    for path, subdirs, files in os.walk(r"C:\Users\5298954\Documents\Projects\Exposure_Map\project_geoserver\data_dir\data\BSW_DIS"):
        for name in files:
